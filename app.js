...
var incompleteTaskHolder=document.querySelector(".task-list.incomplete");//ul of #incompleteTasks
var completedTasksHolder=document.querySelector(".task-list.complete");//completed-tasks
